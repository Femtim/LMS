  ...
  return (
    <>
          ...
          <div className="max-w-6xl mx-auto px-8 py-8 flex gap-8 items-start">
            <div className="flex-1 min-w-0">
                  ...
                  <div className="flex gap-4 items-start">
                    ...
                    <div className="flex-1 min-w-0">
                      ...
                      <div className="flex gap-4">
                        <span className="flex items-center gap-1.5 text-gray-500 text-xs font-medium">👥 {course.instructor.students}</span>
                        <span className="flex items-center gap-1.5 text-gray-500 text-xs font-medium">💬 {course.instructor.reviews}</span>
                      </div>
                    </div>
                  </div>
                </section>
              ...
              {course.studentReviews && course.studentReviews.length > 0 && (
                <section>
                  <h2 className="text-blue-600 font-bold text-base m-0 mb-4 uppercase tracking-wider">What students are saying</h2>
            ...
            <div className="shrink-0 sticky top-20" style={{ width: 280 }}>
              <div className="bg-white border border-gray-200 rounded-2xl p-5 shadow-md">
                ...
                <p className="text-gray-400 text-xs text-center mt-1 mb-4">3-Days Money-Back Guarantee</p>
      ...
      <Modal
        ...
        primaryAction={{ label: "Log In", onClick: goToLogin }}
        secondaryAction={{ label: "Cancel", onClick: () => setShowLoginModal(false) }}
      >
        You need an account to enroll in this course. Log in to continue to payment.
      </Modal>
